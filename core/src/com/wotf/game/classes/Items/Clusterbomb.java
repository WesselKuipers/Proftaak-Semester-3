...
public class Clusterbomb extends Item {
    ...
    public Clusterbomb(String nm) {
        ...
        bullet_sprite = new Sprite(new Texture(Gdx.files.absolute(Pathfinder.getRelativePath() + "clusterbomb.png")));
        weapon_sprite = new Sprite(new Texture(Gdx.files.absolute(Pathfinder.getRelativePath() + "clusterbomb.png")));
        
        this.bullet = new Projectile(bullet_sprite, p);
        this.bullet.isCluster = true;
